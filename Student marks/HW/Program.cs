...
namespace HomeWork1
{
    class Program
    {
        ...
        {
            int credit, per;
            Console.WriteLine("Enter your PASSED cridet: ");
            ...
            {
                Console.WriteLine("Your in FIRST semister and your percentage is NOT BAD you have a CHANCE to COMPENSATE.");
            }
            else if ((credit >= 17) && (credit <= 21) && (per >= 75) && (per <= 85))
            {
                Console.WriteLine("Your in FIRST semister and your percentage is GOOD.");
            }
            else if ((credit >= 17) && (credit <= 21) && (per >= 85) && (per <= 95))
            {
                Console.WriteLine("Your in FIRST semister and your percentage is GREAT.");
            }
            else if ((credit >= 17) && (credit <= 21) && (per >= 95) && (per <= 100))
            {
                Console.WriteLine("Your in FIRST semister and your percentage is the VERY GOOD.");
            }
            else if ((credit >= 22) && (credit <= 38) && (per >= 55) && (per <= 75))
            {
                Console.WriteLine("Your in SECOND semister and your percentage is NOT BAD you have a CHANCE to COMPENSATE.");
            }
            else if ((credit >= 22) && (credit <= 38) && (per >= 75) && (per <= 85))
            {
                Console.WriteLine("Your in SECOND semister and your percentage is GOOD.");
            }
            else if ((credit >= 22) && (credit <= 38) && (per >= 85) && (per <= 95))
            {
                Console.WriteLine("Your in SECOND semister and your percentage is GREAT.");
            }
            else if ((credit >= 22) && (credit <= 38) && (per >= 95) && (per <= 100))
            {
                Console.WriteLine("Your in SECOND semister and your percentage is the VERY GOOD.");
            }
            else if ((credit >= 39) && (credit <= 55) && (per >= 55) && (per <= 75))
            {
                Console.WriteLine("Your in THIRD semister and your percentage is NOT BAD you have a CHANCE to COMPENSATE.");
            }
            ...
            {
                Console.WriteLine("This cridet is out of range please enter your cridet in range of 1 to 149..");
            }
            Console.ReadLine();
        }
    }
